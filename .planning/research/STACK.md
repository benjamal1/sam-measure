...
**Domain:** Local interactive image segmentation (SAM2) + batch scientific image measurement pipeline, macOS/Apple Silicon
**Researched:** 2026-07-07
**Confidence:** MEDIUM (core segmentation runtime has an unresolved MPS bug upstream; measurement/CSV libraries are HIGH-confidence stable choices)
...
# Interactive UI
pip install napari[all] napari-sam

# Measurement + CSV
pip install scikit-image opencv-python pandas pillow matplotlib
...
**If MPS proves unreliable in Phase 1 testing (per the open GitHub issue):**
...
**If napari + existing SAM plugins don't cleanly support SAM2 (only SAM1) at implementation time:**
...
**If the researcher wants a faster interactive loop and accuracy loss on ambiguous needle/thread overlaps is acceptable:**
...
---
*Stack research for: Local SAM2-based thread image segmentation + measurement pipeline*
*Researched: 2026-07-07*
